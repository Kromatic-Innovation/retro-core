...
//
// HARD BOUNDARY: the core NEVER commits a change of its own. It only hands the
...
// router's responsibility, and a router is expected to write proposals out for
// review rather than apply them — the core gives it no path to commit.
