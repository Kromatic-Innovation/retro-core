// Tests for the generic retro orchestrator. Pure — no fs, no network.
// Run: npm test (or `node --test lib/retro-core.test.mjs` from the repo root).
import { test } from "node:test";
import assert from "node:assert/strict";
import { runRetro, printOnlyRouter } from "./retro-core.mjs";

// The core treats a proposal as opaque — these fields are only here to prove
// the objects reach the router by reference and unmodified.
const PROPOSALS = [
  { target: "a", path: "x.md", risk: "low", proposed_change: "do a" },
  { target: "b", path: "y.md", risk: "low", proposed_change: "do b" },
];
